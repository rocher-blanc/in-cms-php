...
var addKey = function( key ) {
    ...
    if( $("meta[name=isadmin]").attr("content") == "1" ) {
        $td.append(
            $("<a>")
                .attr("href", "/admin-site/ext/langue/traduction/remove-key/" + key)
...
var deleteKey = function( key ) {
    ...
    $.ajax({
        url     : '/admin-site/ext/langue/traduction/remove-key-action',
        data    : data,
        method  : "POST",
        dataType: 'json',
        success: function (response) {
